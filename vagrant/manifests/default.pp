...
apache::vhost { "fsi-form-extensions-bundle.dev":
  server_name   => "fsi-form-extensions-bundle.dev",
  serveraliases => [
    "www.fsi-form-extensions-bundle.dev"
  ],
  docroot       => "/var/www/form-extensions-bundle/features/fixtures/project/web",
  port          => '80',
  env_variables => [
],
  priority      => '1',
